    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-16">
        ...
        <div className="mt-16 grid gap-12 md:mt-24 md:grid-cols-5 md:gap-8">
          {journey.map((j, i) => (
            <Reveal as="div" key={j.n} y={44} duration={1.1} delay={i * 0.08} start="top 90%">
              <div className="group relative border-t border-line-light pt-8">
                <span
                  aria-hidden="true"
        ...
        <Reveal as="div" y={24} duration={1} start="top 95%">
          <p className="mt-16 text-center font-mono text-[10px] uppercase tracking-luxe text-stone md:mt-24">
