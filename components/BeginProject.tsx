      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-16">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-12 lg:items-start lg:gap-16">
          <div className="lg:col-span-7">
            <Reveal as="div" y={40} duration={1.4} start="top 90%">
              <TextReveal
                as="h2"
            ...
            <Reveal as="div" y={30} duration={1.1} delay={0.15} start="top 94%">
              <p className="mt-6 max-w-xl text-[14px] leading-[1.8] text-stone">
                {begin.sub}
              </p>
            </Reveal>
          ...
          <div className="lg:col-span-5">
            <Reveal as="div" y={30} duration={1.2} delay={0.2} start="top 90%">
              <div className="rounded-xs border border-line-light bg-paper/5 p-6 md:p-8 backdrop-blur-sm">
                ...
                <div className="mt-6 space-y-4 text-[13px] text-stone">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex flex-col gap-1 font-mono text-[12px] text-brass">
                      <a href={`tel:${contact.phone}`} className="hover:underline">{contact.phone}</a>
                      <a href={`mailto:${contact.email}`} className="hover:underline text-paper/80">{contact.email}</a>
                    </div>
                  </div>
