      ...
      <div className="mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-16">
        ...
        <div className="mt-14 md:mt-20">
          <Reveal as="div" y={50} duration={1.3} start="top 88%">
            <TextReveal
              as="h2"
              className="font-serif text-[clamp(1.8rem,3.6vw,3.4rem)] font-light leading-[1.1] text-ink"
              speed={1.2}
              stagger={0.06}
              delay={0.15}
            >
              <span className="block" data-line>Five principles, held without exception —</span>
